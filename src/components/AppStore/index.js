...
class AppStore extends Component {
  ...
  getFilteredApps = userResults => {
    const {activeTabId} = this.state
    const filteredApps = userResults.filter(
  ...
  getUserResults = () => {
    ...
    const userListItems = appsList.filter(each =>
  ...
  render() {
    ...
    const filteredApps = this.getFilteredApps(userResults)
      ...
      <div className="main-container">
        ...
        <div className="bottom-container">
          <input
            ...
            type="search"
            value={userInput}
            onChange={this.onClickChangeItems}
          />
          <img
        ...
        <ul className="apps-container">
          {filteredApps.map(each => (
            <AppItem appListItems={each} key={each.appId} />
          ))}
        </ul>
      </div>
    )
